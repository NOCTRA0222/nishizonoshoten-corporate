...
export const metadata: Metadata = {
  title: "プロジェクト",
  description:
    "西園商店のプロジェクト。NOCTRA の EC 運営に加え、業務自動化・SNS 運用・画像加工など自社で整えている仕組みを掲載します。",
};
...
export default function ProjectsPage() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-12 sm:py-16">
      <PageHeader
        title="プロジェクト"
        description={`${site.lead} 自社事業での EC 運営と、日々の業務を支える自動化・整理の仕組みを掲載しています。`}
      />
      ...
      >
        ...
        <p className="mb-8 max-w-2xl text-sm leading-relaxed text-charcoal/65">
          自社・運用中の業務改善・自動化の取り組みです。構築内容と、運用上の変化を記載しています。
        </p>
